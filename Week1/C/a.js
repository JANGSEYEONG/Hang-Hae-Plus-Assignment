...
function JuniorEngineer(health, intelligence) {
  ...
  this._isBornGenius = this._intelligence > 10; // 처음부터 _isBornGenius 속성을 가지고있게 만들어 추가적인 히든 클래스를 생성하지 않도록 한다.
...
JuniorEngineer.prototype = Object.create(Worker.prototype, {}); // Worker prototype 상속
JuniorEngineer.prototype._super= function(health){ 
  Worker.call(this, health); //Worker의 생성자 호출, this를 보내 JuniorEngineer 인스턴스에 적용 (apply 이용 시 배열로 파라미터 보낼 수 있음)
}
JuniorEngineer.prototype.getIntelligence= function(){
  return this._intelligence;
}
JuniorEngineer.prototype.work= function(){ 
  Worker.prototype.work.call(this); // Worker.prototype의 work 함수를 호출하여 super.work() 구현 
  this._intelligence++;
}
JuniorEngineer.prototype.isBornGenius= function(){
  return this._isBornGenius ?? false;
}
JuniorEngineer.prototype.constructor = JuniorEngineer; // 나중에 JuniorEngineer를 상속받는 경우를 위해 추가
//- 여기에 코드를 작성하세요
